    ...
    class TopicConfiguration {
        ...
        KafkaAdmin.NewTopics createTopics(KafkaTopicConfigurationProperties topicNames) {
            NewTopic[] array = Stream.of(
                    createTopicFromConfig(topicNames.getMonsterCreated()).stream(),
                    createTopicFromConfig(topicNames.getMonsterRemoved()).stream(),
                    createTopicFromConfig(topicNames.getMonsterUpdated()).stream(),
                    createTopicFromConfig(topicNames.getMonsterTemplateCreated()).stream(),
                    createTopicFromConfig(topicNames.getMonsterTemplateRemoved()).stream(),
                    createTopicFromConfig(topicNames.getMonsterTemplateUpdated()).stream()
