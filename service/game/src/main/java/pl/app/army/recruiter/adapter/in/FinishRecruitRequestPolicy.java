...
@Component
class FinishRecruitRequestPolicy {
    ...
    public FinishRecruitRequestPolicy(RecruiterService recruiterService) {
        this.recruiterService = recruiterService;

        flux.filter(recruiter -> recruiter.getFirstRequest().isPresent())
                .flatMap(builder -> {
    ...
    public static class DataPuller {
        ...
        private final FinishRecruitRequestPolicy finishRecruitRequestPolicy;
        ...
        public void addRecruiter() {
            ...
            recruiterDomainRepository.fetchRecruiterWithRequestEnding(Duration.ofSeconds(31))
                    .doOnNext(finishRecruitRequestPolicy::addRecruiter)
