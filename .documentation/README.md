...
To start the documentation viewer locally, use the following command:
      ...
      docker-compose -p f17 -f .\.documentation\docker-compose-documentation.yaml up -d
...
To stop the local documentation server, use:
      ...
      docker-compose -p f17 -f .\.documentation\docker-compose-documentation.yaml down
